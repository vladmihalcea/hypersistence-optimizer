...
```bash
> unzip hypersistence-optimizer-2.10.0-pack.zip
```

After unzipping the project package, you will get the following file structure:

```bash
creating: hypersistence-optimizer-2.10.0/
   creating: hypersistence-optimizer-2.10.0/lib/
  inflating: hypersistence-optimizer-2.10.0/lib/hypersistence-optimizer-2.10.0-javadoc.jar
  inflating: hypersistence-optimizer-2.10.0/lib/hypersistence-optimizer-2.10.0-sources.jar
  inflating: hypersistence-optimizer-2.10.0/lib/hypersistence-optimizer-2.10.0.jar
   creating: hypersistence-optimizer-2.10.0/docs/
   creating: hypersistence-optimizer-2.10.0/docs/html/
   creating: hypersistence-optimizer-2.10.0/docs/pdf/
  inflating: hypersistence-optimizer-2.10.0/docs/html/asciidoctor.css
  inflating: hypersistence-optimizer-2.10.0/docs/html/coderay-asciidoctor.css
  inflating: hypersistence-optimizer-2.10.0/docs/pdf/InstallationGuide.pdf
  inflating: hypersistence-optimizer-2.10.0/docs/html/InstallationGuide.html
  inflating: hypersistence-optimizer-2.10.0/docs/html/UserGuide.html
  inflating: hypersistence-optimizer-2.10.0/docs/pdf/UserGuide.pdf
  inflating: hypersistence-optimizer-2.10.0/changelog.txt
  inflating: hypersistence-optimizer-2.10.0/LICENSE.txt
  inflating: hypersistence-optimizer-2.10.0/maven-install.bat
  inflating: hypersistence-optimizer-2.10.0/maven-install.sh
  inflating: hypersistence-optimizer-2.10.0/README.txt
```
...
* `hypersistence-optimizer-2.10.0/docs/pdf/InstallationGuide.pdf`
* `hypersistence-optimizer-2.10.0/docs/html/InstallationGuide.html`
...
* `hypersistence-optimizer-2.10.0/docs/html/UserGuide.html`
* `hypersistence-optimizer-2.10.0/docs/pdf/UserGuide.pdf`
