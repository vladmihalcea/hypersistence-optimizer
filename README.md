...
```bash
> unzip hypersistence-optimizer-2.4.2-pack.zip
```

After unzipping the project package, you will get the following file structure:

```bash
creating: hypersistence-optimizer-2.4.2/
   creating: hypersistence-optimizer-2.4.2/lib/
  inflating: hypersistence-optimizer-2.4.2/lib/hypersistence-optimizer-2.4.2-javadoc.jar
  inflating: hypersistence-optimizer-2.4.2/lib/hypersistence-optimizer-2.4.2-sources.jar
  inflating: hypersistence-optimizer-2.4.2/lib/hypersistence-optimizer-2.4.2.jar
   creating: hypersistence-optimizer-2.4.2/docs/
   creating: hypersistence-optimizer-2.4.2/docs/html/
   creating: hypersistence-optimizer-2.4.2/docs/pdf/
  inflating: hypersistence-optimizer-2.4.2/docs/html/asciidoctor.css
  inflating: hypersistence-optimizer-2.4.2/docs/html/coderay-asciidoctor.css
  inflating: hypersistence-optimizer-2.4.2/docs/pdf/InstallationGuide.pdf
  inflating: hypersistence-optimizer-2.4.2/docs/html/InstallationGuide.html
  inflating: hypersistence-optimizer-2.4.2/docs/html/UserGuide.html
  inflating: hypersistence-optimizer-2.4.2/docs/pdf/UserGuide.pdf
  inflating: hypersistence-optimizer-2.4.2/changelog.txt
  inflating: hypersistence-optimizer-2.4.2/LICENSE.txt
  inflating: hypersistence-optimizer-2.4.2/maven-install.bat
  inflating: hypersistence-optimizer-2.4.2/maven-install.sh
  inflating: hypersistence-optimizer-2.4.2/README.txt
```
...
* `hypersistence-optimizer-2.4.2/docs/pdf/InstallationGuide.pdf`
* `hypersistence-optimizer-2.4.2/docs/html/InstallationGuide.html`
...
* `hypersistence-optimizer-2.4.2/docs/html/UserGuide.html`
* `hypersistence-optimizer-2.4.2/docs/pdf/UserGuide.pdf`
