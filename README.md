...
```bash
> unzip hypersistence-optimizer-2.3.1-pack.zip
```

After unzipping the project package, you will get the following file structure:

```bash
creating: hypersistence-optimizer-2.3.1/
   creating: hypersistence-optimizer-2.3.1/lib/
  inflating: hypersistence-optimizer-2.3.1/lib/hypersistence-optimizer-2.3.1-javadoc.jar
  inflating: hypersistence-optimizer-2.3.1/lib/hypersistence-optimizer-2.3.1-sources.jar
  inflating: hypersistence-optimizer-2.3.1/lib/hypersistence-optimizer-2.3.1.jar
   creating: hypersistence-optimizer-2.3.1/docs/
   creating: hypersistence-optimizer-2.3.1/docs/html/
   creating: hypersistence-optimizer-2.3.1/docs/pdf/
  inflating: hypersistence-optimizer-2.3.1/docs/html/asciidoctor.css
  inflating: hypersistence-optimizer-2.3.1/docs/html/coderay-asciidoctor.css
  inflating: hypersistence-optimizer-2.3.1/docs/pdf/InstallationGuide.pdf
  inflating: hypersistence-optimizer-2.3.1/docs/html/InstallationGuide.html
  inflating: hypersistence-optimizer-2.3.1/docs/html/UserGuide.html
  inflating: hypersistence-optimizer-2.3.1/docs/pdf/UserGuide.pdf
  inflating: hypersistence-optimizer-2.3.1/changelog.txt
  inflating: hypersistence-optimizer-2.3.1/LICENSE.txt
  inflating: hypersistence-optimizer-2.3.1/maven-install.bat
  inflating: hypersistence-optimizer-2.3.1/maven-install.sh
  inflating: hypersistence-optimizer-2.3.1/README.txt
```
...
* `hypersistence-optimizer-2.3.1/docs/pdf/InstallationGuide.pdf`
* `hypersistence-optimizer-2.3.1/docs/html/InstallationGuide.html`
...
* `hypersistence-optimizer-2.3.1/docs/html/UserGuide.html`
* `hypersistence-optimizer-2.3.1/docs/pdf/UserGuide.pdf`
