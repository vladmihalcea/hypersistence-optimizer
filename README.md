...
```bash
> unzip hypersistence-optimizer-2.12.1-pack.zip
```
...
creating: hypersistence-optimizer-2.12.1/
  ...
  inflating: hypersistence-optimizer-2.12.1/README.txt
```
...
* `hypersistence-optimizer-2.12.1/docs/pdf/InstallationGuide.pdf`
* `hypersistence-optimizer-2.12.1/docs/html/InstallationGuide.html`
...
* `hypersistence-optimizer-2.12.1/docs/html/UserGuide.html`
* `hypersistence-optimizer-2.12.1/docs/pdf/UserGuide.pdf`
