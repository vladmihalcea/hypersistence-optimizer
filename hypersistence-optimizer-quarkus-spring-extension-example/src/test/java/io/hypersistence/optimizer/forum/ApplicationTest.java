...
public class ApplicationTest {
    ...
    static void beforeAll() {
        ServiceLoader<SessionFactoryBuilderFactory> load = ServiceLoader.load(SessionFactoryBuilderFactory.class);
        for (SessionFactoryBuilderFactory sessionFactoryBuilderFactory : load) {
            System.out.println("SessionFactoryBuilderFactory:" + sessionFactoryBuilderFactory);
        }
    }
